...
/*
This code implements the hierarchical redistribution model, but with a fudge factor.
The fudge factor allows me to adjust inter-firm income dispersion in order to better match US data.
*/

int main()
{
    std::cout  << "Hierarchical Redistribution Model with Fudge Factor" << std::endl;
    ...
    for(int iteration = 0; iteration < n_iterations; iteration++){
        ...
        arma::vec   k_income = k_function(mod_sample.col(0), mod_sample.col(1), k_parameters); // get capitalist income
    ...
    result.save("dividend_top_share_fudge.csv", arma::csv_ascii);
